import os
print('Starting Manual Code Update (v3)...')

# --- Updating architectures.py ---
print('Updating architectures.py...')
...
# --- Updating run_persistent.sh ---
print('Updating run_persistent.sh...')
content = r'''#!/bin/bash
...
# --- Updating collect_results.py ---
print('Updating collect_results.py...')
content = r'''import os
import csv
import pandas as pd
...
if __name__ == "__main__":
    main()
'''
with open('collect_results.py', 'w', encoding='utf-8') as f:
    f.write(content)
